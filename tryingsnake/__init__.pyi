from typing import overload, Any, Callable, Generator, Generic, Iterable, Iterator, Optional, Tuple, Type, TypeVar
...
class Try_(Generic[T]):
    ...
    def filter(self, f: Callable[[T], bool], exception_cls: Type[Exception]=..., msg: Optional[str]=...) -> Try_[T]: ...
...
class Failure(Try_[T]):
    ...
    def filter(self, f: Callable[[T], bool], exception_cls: Type[Exception]=..., msg: Optional[str]=...) -> Failure[T]: ...
